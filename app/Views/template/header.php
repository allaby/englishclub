...
<!-- Mirrored from codeboxr.net/themedemo/unialumni/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Aug 2021 18:41:07 GMT -->
...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="a<?= APPPATH ?>ssets/img/favicon/apple-icon-76x76.png">
                        ...
                        <nav class="main-menu navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="menucontent">
                                <ul class="navbar-nav ml-auto">
                                    <li class="nav-item <?= $activemenu == 'home' ? 'active' : ' ' ?>"><a class="nav-link" href="/">Acceuil</a></li>
                                    <li class="nav-item <?= $activemenu == 'about' ? 'active' : ' ' ?>"><a class="nav-link" href="about">Qui sommes nous ?</a></li>
                                    <li class="nav-item" <?= $activemenu == 'event' ? 'active' : ' ' ?>><a class="nav-link" href="event">Evernement</a></li>
                                    <li class="nav-item" <?= $activemenu == 'contact' ? 'active' : ' ' ?>><a class="nav-link" href="contact">Contact</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>

                    ...
                    <div class="all-event-list">
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="img/event/event-img-1.jpg" class="img-fluid" alt="Upcoming Event">
                        ...
                        <div class="single-upcoming-event">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="img/event/event-img-3.jpg" class="img-fluid" alt="Upcoming Event">
                                        <h4 class="up-event-date">It’s 27 February 2019</h4>
                                    </div>
                                </div>
                    ...
                    <div class="up-event-text">
                        ...
                        <div class="single-upcoming-event">
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="up-event-thumb">
                                        <img src="img/event/event-img-4.jpg" class="img-fluid" alt="Upcoming Event">
                                        <h4 class="up-event-date">It’s 27 February 2019</h4>
                                    </div>
                                </div>
